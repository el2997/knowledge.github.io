var my_video, vid, playbtn, seekslider , curtimetext, durtimetext,seekslider2,fullscreenbtn,mutebtn, volumeslider, video_controls_bar, vol, returnLink;
...
function initializePlayer(){
  ...
  my_video.addEventListener("click", () => returnLink.classList.add("hola2"));
  my_video.addEventListener("dblclick", () => video_controls_bar.classList.remove("hola"));
  my_video.addEventListener("dblclick", () => returnLink.classList.remove("hola2"));
